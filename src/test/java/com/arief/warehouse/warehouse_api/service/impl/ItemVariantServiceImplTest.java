...
class ItemVariantServiceImplTest {
    ...
    void setUp() {
        ...
        itemVariantService = new ItemVariantServiceImpl(itemVariantRepository);
    }

    @Test
    void sell_shouldReduceStock_whenEnoughStock() {
        Long variantId = 1L;
    ...
    @Test
    void sell_shouldThrowOutOfStockException_whenNotEnoughStock() {
        Long variantId = 1L;
        ItemVariant variant = new ItemVariant();
        variant.setId(variantId);
        variant.setSku("SKU-1");
